  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        <div class="content-wrapper" style="background-image: url('admin.jpg'); background-repeat:no-repeat; background-size:cover;"> <!-- 4. content wrapper starts-->
   ...
   <?php
          $query=$admin->ret("SELECT count(*) FROM `resort`");
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `resort` where `resort_status`='pending'");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $b=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `user`");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $c=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `package`");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $d=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body">
                <p class="mb-4">Pending Approvals</p>
