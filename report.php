            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">User Transation Reports</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $query = $admin->ret("SELECT * FROM ((`payment` INNER JOIN `user` ON user.user_id = payment.user_id) INNER JOIN `resort` ON resort.resort_id = payment.resort_id)  where `pay_date` between '$start_date' and '$end_date' ");
                                                while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
                                                    <tr>
                                                        <td><?php echo $row['user_fullname'] ?></td>
                                                        <td><?php echo $row['resort_name'] ?></td>
                                                        <td><?php echo $row['total_pay'] ?></td>
                                                        <td><?php echo (($row['total_pay']*10)/100) ?></td>
