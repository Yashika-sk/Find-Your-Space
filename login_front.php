        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 style="text-align:center; color:#4B49AC; font-family: Arial, sans-serif;"><b>Admin Login</b></h4>
              <form class="pt-3" action="admin_controller\login_controller.php" method="POST" autocomplete="off">
