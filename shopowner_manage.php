                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM `shopowner` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                            <td><?php echo $row['owner_id']?></td>
                            <td><img src="../shopowner/uploads/<?php echo $row['imagedb'] ?>" height="800px" width="800px"></td>
                          ...
                          <?php } else { ?>
                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="admin_controller\owner_controller.php?update_status=<?php echo $row['owner_id'] ?>">Approve</a></td>
                          <?php } ?>
                          <!-- end of approve condition -->

                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\owner_controller.php?delete_owner=<?php echo $row['owner_id'] ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
                        </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
